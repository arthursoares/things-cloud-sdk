...
func TestStateQueries(t *testing.T) {
	...
	mustSaveTask(t, syncer, &things.Task{UUID: "inbox-1", Title: "Inbox Task", Schedule: things.TaskScheduleInbox, Status: things.TaskStatusPending})
	mustSaveTask(t, syncer, &things.Task{UUID: "anytime-1", Title: "Anytime Task", Schedule: things.TaskScheduleAnytime, Status: things.TaskStatusPending})
	mustSaveTask(t, syncer, &things.Task{UUID: "today-1", Title: "Today Task", Schedule: things.TaskScheduleAnytime, ScheduledDate: &today, Status: things.TaskStatusPending})
	mustSaveTask(t, syncer, &things.Task{UUID: "someday-1", Title: "Someday Task", Schedule: things.TaskScheduleSomeday, Status: things.TaskStatusPending})
	mustSaveTask(t, syncer, &things.Task{UUID: "upcoming-1", Title: "Upcoming Task", Schedule: things.TaskScheduleSomeday, ScheduledDate: &tomorrow, Status: things.TaskStatusPending})
	mustSaveTask(t, syncer, &things.Task{UUID: "completed-1", Title: "Completed Task", Schedule: things.TaskScheduleAnytime, Status: things.TaskStatusCompleted})
	mustSaveTask(t, syncer, &things.Task{UUID: "trashed-1", Title: "Trashed Task", InTrash: true})
	mustSaveTask(t, syncer, &things.Task{UUID: "project-1", Title: "Test Project", Type: things.TaskTypeProject})
	mustSaveTask(t, syncer, &things.Task{UUID: "heading-1", Title: "Test Heading", Type: things.TaskTypeHeading, ParentTaskIDs: []string{"project-1"}})
	mustSaveTask(t, syncer, &things.Task{UUID: "under-heading-1", Title: "Under Heading Task", ActionGroupIDs: []string{"heading-1"}, Schedule: things.TaskScheduleAnytime, Status: things.TaskStatusPending})
	mustSaveTask(t, syncer, &things.Task{UUID: "tagged-1", Title: "Tagged Task", TagIDs: []string{"tag-1"}, Schedule: things.TaskScheduleAnytime, Status: things.TaskStatusPending})
	mustSaveTask(t, syncer, &things.Task{UUID: "search-1", Title: "Needle Task", Note: "hidden haystack", Schedule: things.TaskScheduleAnytime, Status: things.TaskStatusPending})
